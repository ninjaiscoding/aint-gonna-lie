...
const gameDatabase = {
    ...
    "Rooms in a House": ["Kitchen", "Bathroom", "Bedroom", "LivingRoom", "DiningRoom", "Basement", "Garage", "Closet", "Office", "Study", "Library", "Nursery", "Playroom", "StorageRoom"],
    "Space": ["Sun", "Moon", "Mercury", "Venus", "Earth", "Mars", "Jupiter", "Saturn", "Uranus", "Neptune", "Pluto", "Milky Way", "Andromeda", "Orion Nebula", "Crab Nebula", "Black Hole", "Sagittarius A*", "Solar Eclipse", "Lunar Eclipse", "Supernova", "Meteor Shower", "Aurora Borealis", "Quasar", "Pulsar", "Asteroid Belt"],
