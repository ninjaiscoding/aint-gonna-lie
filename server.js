...
const gameDatabase = {
    ...
    "Electronics": ["Smartphone", "Laptop", "Television", "Tablet", "Computer", "Smartwatch", "Headphones", "Speaker", "Camera", "Drone", "Projector", "Printer", "Scanner", "Monitor", "Keyboard", "Mouse", "Microphone", "Charger", "Battery", "Flashlight", "Calculator", "Controller", "Thermostat", "Refrigerator", "Microwave", "Blender", "Oven", "Vacuum", "Fan", "Heater", "Airconditioner", "Lamp", "Clock", "Radio", "Plug", "Sensor", "Remote"],
